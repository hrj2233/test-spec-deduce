...
describe("myRange(min, max, step)", () => {
  context("if step is not provided", () => {
    it("should return the correct array with default value step=1", () => {
      ...
      const actual1 = myRange(min1, max1); //should true
      const expected1 = [0, 1, 2, 3, 4, 5];
      const actual2 = myRange(min2, max2); // should true
      const expected2 = [];
  ...
  context("if step is provided", () => {
    it("should return the correct array", () => {
      ...
      const actual1 = myRange(min1, max1, step1); //should true
      const expected1 = [0, 1, 2, 3, 4, 5];
      const actual2 = myRange(min2, max2, step2); //should true
      const expected2 = [0, 2, 4]; 
      const actual3 = myRange(min3, max3, step3); //should true
      const expected3 = []; 
